...
static int calculate_watchpoints (enum debug_unit_action action,
				  unsigned long          udata);
static int get_devint_reg (int addr,
			   unsigned long *data);
static int set_devint_reg (int addr,
			   unsigned long  data);
...
/*---------------------------------------------------------------------------*/
static int
get_devint_reg (int address, unsigned long *data)
{
  int  err = ERR_NONE;
...
/*---------------------------------------------------------------------------*/
static int
set_devint_reg (int address, unsigned long data)
{
  int err =  ERR_NONE;
